...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "Contracts Control Room"),
    React.createElement("p", null, "Contract truth, entitlement posture, renewal timing, and governed billing schedule requests."),
    React.createElement(
      "p",
      null,
