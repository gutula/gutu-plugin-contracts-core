# Contracts Core Business Rules

## Invariants

- The plugin remains authoritative only for the data declared in `contracts-core` and its owned resource set.
...
- ERP parity references are tracked against: `CRM`, `Selling`.
