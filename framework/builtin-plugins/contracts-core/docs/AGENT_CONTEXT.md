...
- Package root: `framework/builtin-plugins/contracts-core`
- Service layer: `framework/builtin-plugins/contracts-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/contracts-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/contracts-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/contracts-core/src/ui`

## Safe assumptions

- Use `contracts-core` as the stable plugin identifier and `@plugins/contracts-core` as the package import name.
