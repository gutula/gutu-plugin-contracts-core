...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/contracts-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-contracts-core:");
...
console.log("Documentation check passed for gutu-plugin-contracts-core.");
